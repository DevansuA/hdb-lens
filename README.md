...
7. **Engineered like software.** Typed, documented `src/` package · 14 unit tests · ruff linting · GitHub Actions CI across Python 3.10–3.12 · Dockerized Streamlit app · Makefile workflow.
